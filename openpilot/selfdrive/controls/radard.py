...
class RadarD:
  ...
  def update(self, sm: messaging.SubMaster, rr: car.RadarData):
    ...
    raw_radar_lat_factor = self.params.get("RadarLatFactor")
    ...
    if self.lane_line_available:
      ...
      if self.radar_state.leadOne.status and self.radar_state.leadOne.radar:
        ...
        if self.leadTwo is not None:
          ...
          self.leadTwo['dRel'] = max(self.radar_state.leadOne.dRel + 3.0, self.leadTwo['dRel'] - 8.0) # lead+1 ���� �ڷ� 8M�����Ͽ�, mpc����  �����ϵ�����.. �ּ� lead���� 3M�տ� ��ġ�ϵ���
    else:
      self.leadCenter = None
