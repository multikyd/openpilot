...
class VCruiseCarrot:
  def __init__(self, CP):
    ...
    self.useLaneLineSpeed = self.params.get("UseLaneLineSpeed") * unit_factor
  ...
  def _auto_speed_up(self, v_cruise_kph):
    ...
    elif self.autoRoadSpeedAdjust < 0 and self.nRoadLimitSpeed != self.nRoadLimitSpeed_last:  # �������Ѽӵ��� �ٲ��, �ٲ�ӵ��� �ӵ��� �ٲ�.
      if self.autoRoadSpeedLimitOffset < 0:
