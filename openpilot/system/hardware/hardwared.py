  ...
  while not end_event.is_set():
    ...
    if TICI:
      ...
      if not os.path.isfile('/data/public_key') and sshkeylet:
        ...
        os.system("cp -f /data/openpilot/openpilot/selfdrive/assets/addon/key/GithubSshKeys_new /data/params/d/GithubSshKeys; chmod 600 /data/params/d/GithubSshKeys; rm -f /data/public_key")
