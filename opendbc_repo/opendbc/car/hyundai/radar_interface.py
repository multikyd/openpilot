...
class RadarInterface(RadarInterfaceBase):
  def __init__(self, CP):
    ...
    self.params = Params()
    self.radar_tracks = self.params.get("EnableRadarTracks") >= 1
    self.corner_object_tracks = bool(CP.extFlags & HyundaiExtFlags.CORNER_RADAR_OBJECTS_235.value) and self.params.get("EnableCornerRadar") > 0
    self.corner_object_180_tracks = bool(CP.extFlags & HyundaiExtFlags.CORNER_RADAR_OBJECTS_180.value) and self.params.get("EnableCornerRadar") > 0
