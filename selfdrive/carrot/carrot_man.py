...
class CarrotMan:
  def __init__(self):
    ...
    self.sm = messaging.SubMaster(['deviceState', 'carState', 'controlsState', 'radarState', 'longitudinalPlan', 'modelV2', 'selfdriveState', 'carControl', 'navInstruction'])
  ...
  def carrot_speed_serv(self, carrot_speed, frame):
    ...
    if self.v_cruise_change != 0:
      ...
      self.params_memory.put_nonblocking("CarrotSpeed", int(vt))  # m/s to km/h
